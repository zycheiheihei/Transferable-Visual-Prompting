...
def get_model(model_name):
    if model_name.lower() == 'blip2':
        ...
        return TestBlip2()
    elif model_name.lower() == 'instructblip':
        from .test_instructblip import TestInstructBLIP
        return TestInstructBLIP()
    elif model_name.lower() == 'llama-adapter-v2':
