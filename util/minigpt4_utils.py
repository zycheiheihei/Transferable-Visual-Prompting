...
def load_model(llm_name:str, device='cuda') -> MiniGPT4:
    ...
    llama_model = "model_weights/vicuna-7b-v0" if '7b' in llm_name.lower() \
                else "model_weights/vicuna-13b-v0"
    model = MiniGPT4(llama_model=llama_model, max_txt_len=256)
    ckpt_path = "model_weights/prerained_minigpt4_7b.pth" if '7b' in llm_name.lower() \
                else "model_weights/pretrained_minigp4.pth"
